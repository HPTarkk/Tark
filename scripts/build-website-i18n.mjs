...
//
// The landing page only. The privacy policy and the terms are rendered in
// both languages straight from website/legal/*.json by
// scripts/build-legal-pages.mjs — they have no English source document to
// derive a Persian one from, because neither language is the original.
//
