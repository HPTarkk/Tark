...
/// Bounded optional opaque proof trailer for an existing Ping/Pong control
/// packet. The proof is public certificate/signature material; private key bytes
/// are never accepted by this carrier.
///
/// Framing is additive and self-identifying so older v3 decoders continue to
/// ignore the tail while newer builds can fail closed on malformed/unknown
/// records without changing the packet version.
abstract final class TransportRouteProofWire {
  static const marker = 0x52; // 'R' for route proof.
