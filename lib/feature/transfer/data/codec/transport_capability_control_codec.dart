...
final class TransportCapabilityControlCodec {
  ...
  /// header decoder intentionally accepts a non-empty one. Trailer parsing must
  /// therefore honor the encoded name length instead of assuming the body
  /// always starts four bytes after the epoch. Malformed/truncated headers fail
  /// closed to no optional evidence.
...
final class DecodedTransportCapabilityControl {
  ...
  /// payload-controlled. Room capability/proof attribution must preserve the
