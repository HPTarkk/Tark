...
class HostHotspotRecoveryMachine {
  ...
  /// Call only after the native reservation and its fresh credentials have
  /// been atomically published to the active TransportAttachment/invite owner.
  ...
  /// "Peer present" is not enough. Only bidirectional reachability may move
  /// the state to restored/live.
