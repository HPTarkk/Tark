    ...
    return MaterialApp.router(
      ...
      builder: (context, child) => RepaintBoundary(
        ...
        child: KeyedSubtree(
          ...
          // Consent is deliberately deferred until Tark has a real identity /
          // profile signup boundary that can persist a meaningful acceptance.
          // Keep the legal feature available, but do not block the offline
          // beta's first launch with an acceptance wall that cannot yet be
          // tied to an account.
          child: child!,
        ),
      ),
