...
abstract class AppLocalizations {
  ...
  /// No description provided for @smart_music_ducking.
  ///
  /// In fa, this message translates to:
  /// **'آهنگ خودش کم بشه وقتی یکی حرف می‌زنه'**
  String get smart_music_ducking;

  /// No description provided for @smart_music_ducking_desc.
  ///
  /// In fa, this message translates to:
