...
void main() {
  test(
    'Room QR join persists membership before spending network payload',
    () async {
      ...
      expect(
        ...
        reason:
            'Transport bootstrap must only consume the same scan after the '
  ...
  test(
    'active Room Add person opens exactly the one-scan invite surface',
    () async {
